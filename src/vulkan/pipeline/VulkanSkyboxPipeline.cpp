...
void VulkanSkyboxPipeline::create(
    VkDevice device,
    VkExtent2D extent,
    ...
    VkDescriptorSetLayout descriptorLayout)
{
    ...
    VkShaderModule fragModule =
        ShaderLoader::load(device, "shaders/compiled/skybox.frag.spv");
    ...
    // Depth test/write both disabled - drawn first, before the grid, and
    // must never write depth (see class comment).
...
void VulkanSkyboxPipeline::destroy(VkDevice device)
{

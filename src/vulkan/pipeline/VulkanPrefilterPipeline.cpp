...
void VulkanPrefilterPipeline::create(
    VkDevice device,
    VkExtent2D extent,
    ...
    VkDescriptorSetLayout descriptorLayout)
{
    ...
    VkShaderModule fragModule =
        ShaderLoader::load(device, "shaders/compiled/prefilterEnv.frag.spv");
...
void VulkanPrefilterPipeline::destroy(VkDevice device)
{

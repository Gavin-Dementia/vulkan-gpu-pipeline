...
void VulkanIrradiancePipeline::create(
    VkDevice device,
    VkExtent2D extent,
    ...
    VkDescriptorSetLayout descriptorLayout)
{
    ...
    VkShaderModule fragModule =
        ShaderLoader::load(device, "shaders/compiled/irradianceConvolve.frag.spv");
...
void VulkanIrradiancePipeline::destroy(VkDevice device)
{
